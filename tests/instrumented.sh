...
do
   ...
   echo "$prefix $exeprefix ./alexander $args $postfix"
   eval "$prefix $exeprefix ./alexander $args $postfix"

done

# verify the generated net equals the base net
network=`./alexander uci | grep 'option name EvalFile type string default' | awk '{print $NF}'`
