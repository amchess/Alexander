...
constexpr int OPENING_PHASE_PLY_INTERMEDIATE =
  25;                                           // Intermediate (2000-2199) begin strategic errors
...
struct HandicapConfig {
    ...
    HandicapConfig() :
        limitStrength(false),
        pawnsToEvaluate(true),
        winnableToEvaluate(true),
        imbalancesToEvaluate(true),
        simulateHumanBlunders(false),
        handicappedDepth(false),
        uciElo(MAX_ELO) {}
};
